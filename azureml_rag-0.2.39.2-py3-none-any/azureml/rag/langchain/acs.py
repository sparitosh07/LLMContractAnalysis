...
class AzureCognitiveSearchVectorStore(VectorStore):
    ...
    def __init__(
        ...
        from azureml.rag.utils.connections import get_default_azure_credential

        self.endpoint = endpoint
        self.index_name = index_name
        self.credential = credential if credential is not None else get_default_azure_credential()
